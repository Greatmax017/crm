                ...
                <div class="col-md-3 md-margin-bottom-40">
                    <div class="posts">
                        ...
                        <ul class="list-unstyled latest-list">
                            @foreach(App\Post::where('tutorial', 0)->latest()->limit(4)->get() as $p)
								<li>
									<a href="/blog/{{ $p->url }}">{{ $p->title }}</a>
									<small>{{ $p->created_at->toFormattedDateString() }}</small>
								</li>
							@endforeach
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="footer-socials list-inline">
                        <li>
                            <a href="https://t.me/joinchat/D0aHLUVDBu4E5fS39l1DfQ" class="tooltips" data-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook">
                        ...
                        <li>
                            <a href="https://t.me/joinchat/D0aHLUVDBu4E5fS39l1DfQ" class="tooltips" data-toggle="tooltip" data-placement="top" title="" data-original-title="Google Plus">
