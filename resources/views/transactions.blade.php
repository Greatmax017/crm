                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <!-- <td class="border-b">
                                           ...
                                           <td class=" border-b w-32">{{ substr($t->id, 0, 13) }}</td>
                                        ...
                                        <td class="border-b w-32 font-medium">&#8358;{{ number_format($t->amount, 2) }}</td>
                                          <td class="border-b w-32 font-medium">&#8358;{{ number_format($t->old_balance, 2) }}</td>
                                            <td class="border-b w-32 font-medium">&#8358;{{ number_format($t->new_balance, 2) }}</td>
