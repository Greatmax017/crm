...
@section('content')
      ...
      <section class="banner-section" id="home">
        ...
        <div
          class="banner-bg d-none d-lg-block bg_img"
          data-background="assets/images/banner/banner.jpg"
        >
          <div
            class="chart-1 wow fadeInLeft"
            data-wow-delay=".5s"
          ...
          <div class="row">
            <div class="col-xl-5 col-lg-6 offset-lg-6 offset-xl-7">
              <div class="banner-content">
                <h1 class="title">
                  Simple <span>Profitable & </span> Convenient
                </h1>
          ...
          <div class="row align-items-center mb-30-none justify-content-center">
            <div class="col-sm-6 col-md-4">
              <div class="counter-item">
                <div class="counter-thumb">
                  <img
                    src="assets/images/counter/counter01.png"
                    alt="counter"
                  />
                </div>
                <div class="counter-content">
                  <div class="counter-header">
                    <h3 class="title odometer" data-odometer-final="3625">0</h3>
                    <h3 class="title"></h3>
                  </div>
            ...
            <div class="col-sm-6 col-md-4">
              <div class="counter-item">
                <div class="counter-thumb">
                  <img
                    src="assets/images/counter/counter02.png"
                    alt="counter"
                  />
                </div>
                <div class="counter-content">
            ...
            <div class="col-sm-6 col-md-4">
              <div class="counter-item">
                <div class="counter-thumb">
                  <img
                    src="assets/images/counter/counter03.png"
                    alt="counter"
                  />
                </div>
                <div class="counter-content">
                  <div class="counter-header">
                    <h3 class="title">$</h3>
                    <h3 class="odometer title" data-odometer-final="5285">0</h3>
                    <h3 class="title"></h3>
                  </div>
                  <p>Investment Deposited</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="section-header left-style">
                <span class="cate">WELCOME TO alstomfx</span>
                <h2 class="title">about alstomfx</h2>
                <p>
                  Alstomfx is an investment company, whose team is working on
                  making money from the volatility of Binary Options Trading,
                  Forex Trading and cryptocurrencies and offer great returns to
                  our clients.
                </p>
              </div>
      ...
      <section
        class="feature-section padding-top padding-bottom bg_img"
          ...
          <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
              <div class="section-header">
                ...
                <h2 class="title">why should you invest</h2>
                <p class="mw-100">
            ...
            <div class="col-md-6 col-sm-10 col-lg-4">
              <div class="feature-item">
                ...
                <div class="feature-content">
                  ...
                  <p>
                    We create and spot oppotunities to make life better for our
                    cleints.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6 col-sm-10 col-lg-4">
              <div class="feature-item">
                ...
                <div class="feature-content">
                  ...
                  <p>
                    Our system is fully protected with Cloudflare for optimum
                    security.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6 col-sm-10 col-lg-4">
              <div class="feature-item">
                ...
                <div class="feature-content">
                  ...
                  <p>
                    You mean so much to us which is why we are always available
                    for you.
                  </p>
                </div>
              </div>
                  ...
                  <ul class="tab-menu">
                    <li class="active">
                      ...
                      <div class="menu-content">
                        ...
                        <p>
                          Click <a href="/register">Sign Up</a> to fill the
                          form, our 256 SSL will Protect your privacy.
                        </p>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="menu-content">
                        ...
                        <p>
                          <a href="/login">Login</a> your account to click
                          invest and start making profits.
                        </p>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="menu-content">
                        ...
                        <p>
                          You will get your profit on your dashboard in
                          realtime, also you will get Instant Payment
                        </p>
                      </div>
                    </li>
                  </ul>
      ...
      >
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-7">
              <div class="call--item">
                <span class="cate">We are always ready</span>
                <h3 class="title">Request a call back</h3>
              </div>
            </div>
            <div class="col-lg-5">
              <div class="call-button">
                <a href="Tel:+234812345523" class="call">
              ...
              <div class="calculate-area">
                <div class="calculate-item">
                  ...
                  <select class="select-bar">
                    <option value="01">20% Monthly</option>
                    <option value="02">25% Monthly</option>
                    <option value="03">30% Monthly</option>
                  </select>
                </div>
                <div class="calculate-item">
                  <h5 class="title" data-serial="02">Select the currency</h5>
                  <ul class="tab-menu">
                    <li class="active" >NGN</li>
                    
                  </ul>
                </div>
                <div class="calculate-item">
                  <h5 class="title" data-serial="03">Enter the amount</h5>
                  <input type="number" value="100" id="myInput" oninput="myFunction()" />
                </div>
              </div>
              <div class="tab-area">
...
function myFunction() {
  ...
  document.getElementById("demo2").innerHTML = x * 0.20;
      ...
      <!--<section
        class="latest-transaction padding-top padding-bottom"
        id="transaction"
      >
        <div
          class="transaction-bg bg_img"
        ...
        <div class="container">
            ...
            <div class="col-lg-8 col-xl-7">
              <div class="section-header">
                ...
                <p>
                  ...
                  investor.Withthis in mind, we hand-pick the investments we
          ...
          <div
            class="tab transaction-tab d-flex flex-wrap justify-content-center"
          >
            <ul class="tab-menu">
              <li class="active">
                <div class="thumb">
                ...
                <div class="row justify-content-center mb-30-none">
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      <div class="transaction-header">
                        ...
                        <span class="date">October 24, 17:57</span>
                      </div>
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction01.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
                        <span class="amount">Amount</span>
                        <h5 class="sub-title">&#8358;400,000</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      <div class="transaction-header">
                        ...
                        <span class="date">October 24, 14:57</span>
                      </div>
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction02.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
                        <span class="amount">Amount</span>
                        <h5 class="sub-title"> &#8358;520,000</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      ...
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction03.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
                  ...
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      ...
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction04.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
                  ...
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      ...
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction05.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
                  ...
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      ...
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction06.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
                  ...
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      ...
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction07.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
                  ...
                  <div class="col-lg-4 col-xl-3 col-sm-6">
                    <div class="transaction-item">
                      ...
                      <div class="transaction-thumb">
                        <img
                          src="assets/images/transaction/transaction08.png"
                          alt="transaction"
                        />
                      </div>
                      <div class="transaction-footer">
          ...
          <div class="row">
            <div class="col-lg-7 padding-bottom padding-top">
              <div class="section-header left-style">
                ...
                <h2 class="title fz-md-49">Refferal Program</h2>
                <p>
                ...
                <div class="affiliate-item">
                  <div class="affiliate-inner">
                    <div class="affiliate-thumb">
                      ...
                      <span class="cont">1st deposit</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="affiliate-bottom">
                <h6 class="title">Make money with alstomfx</h6>
            ...
            <div class="col-lg-5 d-lg-block d-none">
              <div class="afiliate-thumb">
                <img
                  src="assets/images/affiliate/affiliate.png"
                  alt="affiliate"
                />
              </div>
            </div>
            ...
            <div class="col-md-7 col-xl-6">
              <div class="call-item text-center text-sm-left">
                ...
                <div class="call-content">
                  <h5 class="title">
                    Ready To Start Your Earnings Through Forex Trading?
                  </h5>
                </div>
              </div>
            </div>
            <div
              class="col-md-5 col-xl-6 text-center text-sm-left text-md-right"
            >
          ...
          <div class="row">
            <div class="col-lg-8 col-md-10">
              <div class="section-header left-style">
                ...
                <h2 class="title">
                  <span>2,000</span> HAPPY CLIENTS AROUND THE WORLD
                </h2>
                <p class="mw-500">
                ...
                <div class="client-slider owl-carousel owl-theme">
                  <div class="client-item">
                    <div class="client-content">
                      <p>Perfect work to start on, support is awesome</p>
                      <div class="rating">
                        <span>
                  ...
                  <div class="client-item">
                    <div class="client-content">
                      <p>Very easy to use, perfect for investment</p>
                      <div class="rating">
                        <span>
                          <i class="fas fa-star"></i>
                        </span>
                  ...
                  <div class="client-item">
                    <div class="client-content">
                      <p>Awesome alstomfx most profitable site!</p>
                      <div class="rating">
                        <span>
                          <i class="fas fa-star"></i>
                        </span>
