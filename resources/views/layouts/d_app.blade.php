...
<html lang="en">
	<head>
		...
		<link type="image/x-icon" href="{{ url('img/core-img/favicon.ico') }}" rel="icon" />

		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		<meta name="csrf-token" content="{{ csrf_token() }}">
		<title>Mobile VTU Plus |  @if(Request::segment(1) == '') Home @else {{ ucfirst(Request::segment(1)) }} @endif</title>
		 ...
		 @include('sections.sidebar_2')
		   <body class="app loading">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">MobileVTUPlus</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">{{ ucfirst(Request::segment(1)) }}</a> </div>
                    <!-- END: Breadcrumb -->
