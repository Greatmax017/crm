            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <form class="form-horizontal mt-4 pt-2 ng-pristine "   method="POST" action="{{ url('/register') }}" >
                        {{ csrf_field() }}
                        ...
                        @endif
                                        ...
                                        <div class="row">
                                            <div class="mb-3">
                                                ...
                                                <input style="opacity: 0;" class="front form-control file-opacity ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required"  type="file" accept="image/*" ng-model="registerform.cardfront" name="cardfront" >
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input style="opacity: 0;" class="nagitive form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" type="file" accept="image/*" ng-model="registerform.cardnagitive" name="cardback" id="cardnagitive"  >
                                            </div>
                                        </div>
