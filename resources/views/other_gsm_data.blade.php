...
<input type="hidden" name="desc" value="Other Network Data Purchase">
     ...
     <div class="mt-3">
         ...
         <input readonly id="myinput" type="number" name="amount" class="input w-full border mt-2" placeholder="Enter Amount" required>
         </div><br>
