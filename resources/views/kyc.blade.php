                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control ng-pristine ng-untouched ng-not-empty ng-valid ng-valid-required" disabled="" type="text" ng-model="resInfo.RealName" value="{{$user->fname}} {{$user->surname}}" name="sname"  required="" data-msg-required="This field is required" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="ng-binding">Phone：</label>
                                            <div class="mb-3">
                                                <input class="form-control ng-pristine ng-untouched ng-valid-minlength ng-valid-maxlength ng-not-empty ng-valid ng-valid-required" disabled="" autocomplete="off" value="{{$user->phone}}" data-rule-phonemobile="true" data-msg-phonemobile="* The cell phone number is not valid" minlength="8" maxlength="16" required="" data-msg-required="* The phone number cannot be empty" name="mobile" type="text" ng-model="resInfo.PhoneNumber">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control ng-pristine ng-untouched ng-valid-email ng-not-empty ng-valid ng-valid-required" disabled="" id="email" autocomplete="off" type="email" name="email" value="{{$user->email}}" ng-model="resInfo.Email" required="" data-msg-required=" *Mailbox is required" email="" data-msg-email=" Illegal email address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                      ...
                                      <form method="POST" id="kyc" enctype="multipart/form-data" action="/kyc">
                                            ...
                                            <select  required="" data-msg-required="This field is required" name="cardtype"  ng-if="Language!=&#39;zh&#39;" class="form-select ng-pristine ng-untouched ng-scope ng-not-empty ng-valid ng-valid-required" id="sfz" name="sfz" >
                                                <option value="">{{$user->cardtype}}</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <label for="cardfront" language="en" class="cardfront ng-isolate-scope" file-upload="commondialogOption" data-config="{&quot;card&quot;:&quot;CardNumber1&quot;,&quot;type&quot;:&quot;imgchoose&quot;,&quot;max-size&quot;:&quot;&quot;,&quot;shows&quot;:&quot;.imga&quot;,&quot;triggerCls&quot;:&quot;.show_btn&quot;,&quot;fileClass&quot;:&quot;.front&quot;}">
                                                    ...
                                                    <!-- ngIf: resInfo.CardNumber1 --><img ng-if="resInfo.CardNumber1" class="img-fluid ng-scope" ng-src="" height="315" width="315" src="@if (Auth::user()->cardfront != null)/images/{{Auth::user()->cardfront}} @else imgs/logo.png @endif"><!-- end ngIf: resInfo.CardNumber1 -->
                                                </label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <label for="cardnagitive" language="en" class="cardnagitive ng-isolate-scope" file-upload="commondialogOption" data-config="{&quot;card&quot;:&quot;CardNumber2&quot;,&quot;type&quot;:&quot;imgchoose&quot;,&quot;max-size&quot;:&quot;&quot;,&quot;shows&quot;:&quot;.imgas&quot;,&quot;triggerCls&quot;:&quot;.cardshow_btn&quot;,&quot;fileClass&quot;:&quot;.nagitive&quot;}">
                                                    ...
                                                    <!-- ngIf: resInfo.CardNumber2 --><img ng-if="resInfo.CardNumber2"  class="img-fluid ng-scope" height="315" width="315" src="@if (Auth::user()->cardback != null)/images/{{Auth::user()->cardback}} @else imgs/logo.png @endif" ><!-- end ngIf: resInfo.CardNumber2 -->
                                                </label>
