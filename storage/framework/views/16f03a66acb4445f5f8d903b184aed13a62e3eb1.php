                    	...
                    	<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table">
										<tbody>
											<tr><td><b>Full Name</b></td><td> <?php echo e(isset($user->name) ? $user->name : '', false); ?><br /> <a href="/manual/login/<?php echo e($user->id, false); ?>" class="btn btn-xs btn-success">Login to account</a></td></tr>
											...
											<tr><td><b>Wallet Balance:</b></td><td>&#8358;<?php echo e(number_format($user->balance, 2), false); ?>
												...
												<form method="POST" action="/admin/deduct">
													<?php echo e(csrf_field(), false); ?>

													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="amount" type="number" required>
												<button type="submit" class="btn btn-xs btn-success">Deduct money</button>
											</form>
											</td></tr>
										</tbody>
									</table>
