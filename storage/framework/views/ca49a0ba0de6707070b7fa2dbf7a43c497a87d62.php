							...
							<div class="panel-body table-responsive">
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<td class="col-md-2"><b><?php echo e($c->title); ?></b></td>
											<td class="col-md-2"><b><?php if(!is_null($c->thumbnail)): ?><a href="<?php echo e($c->thumbnail); ?>" target="_blank">View</a><?php endif; ?></b></td>
                                            <td class="col-md-2"><b><?php echo e($c->created_at->toDayDateTimeString()); ?></b></td>
                                            <td class="col-md-2"><b><?php echo e($c->view_count); ?></b></td>
											<td class="col-md-2">
                                                <?php if(Auth::user()->isAdmin()): ?>
                                                <a onclick="submitForm(this);" form-id="post-delete-form-<?php echo e($c->id); ?>" form-action="delete this article" class="btn btn-sm btn-danger">
                                                    <i class="fa fa-trash-o" aria-hidden="true"></i>
                                                </a>
                                                <a href="/admin/blog/<?php echo e($c->id); ?>/edit" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </a>
                                                <form id="post-delete-form-<?php echo e($c->id); ?>" class="form" role="form" method="POST" action="/admin/blog/<?php echo e($c->id); ?>">
													<?php echo e(csrf_field()); ?>

                                                    <input type="hidden" name="_method" value="delete" />
													<input type="hidden" value="<?php echo e($c->id); ?>" name="post" />
												</form>
                                                <?php endif; ?>
