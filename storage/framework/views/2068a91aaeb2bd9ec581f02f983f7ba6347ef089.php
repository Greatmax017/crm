								...
								<div class="table-responsive">
									<table class="table">
										<tbody>
											...
											<tr><td><b>Bank:</b></td><td><b><?php echo e($user->bank, false); ?></b></td></tr>
											<tr><td><b>Account Number:</b></td><td><b><?php echo e($user->accountno, false); ?></b></td></tr>
											<tr><td><b>Withdrawal Method:</b></td><td><b><?php echo e($user->withdrawal_method, false); ?></b></td></tr>
											<tr><td><b>Method ID:</b></td><td><b><?php echo e($user->pay2, false); ?></b></td></tr>
                                            ...
                                            <tr><td><b>Total Active Investments:</b></td><td>&#8358;<?php echo e(number_format(\App\Transaction::where('sender', $user->id)->where('status', 1)->sum('amount'), 2), false); ?></td></tr>
										</tbody>
									</table>
								</div>
								<div class="col-md-6">
