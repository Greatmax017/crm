            ...
            <!-- BEGIN: Personal Information -->
             ...
             <form class="validate-form" role="form" method="POST" action="/buy_airtime">
                 ...
                 <img id="myimage" src="/img/core-img/logo.png" style="width:70px; height:70px;display:block; margin:7px;">
                  <p>Check data Baln : GLO: #127*0#   AIRTEL: *140#   9MOBILE :*229*9#</p>
  <input type="hidden" name="endpoint" value="https://vtutopcenter.com/api/products/othernetworkdata">
 <br>
                <div> <label>Select Network</label>
                            <div class="mt-2"> 
                        <select name="selectLevel" id="selectLevel" name="network" class="form-control w-full">
                ...
                <div> <label>Select Data Bundle</label>
                    <div class="mt-2"> 
                <select name="bundle_code" id="ColorSelect" onchange="javascript:flip();" class="w-full">
     ...
     <div class="mt-3"> 
         ...
         <input readonly id="myinput" min="100" max="25000" type="number" name="amount" class="input w-full border mt-2" placeholder="Enter Amount" required>
         </div><br>
