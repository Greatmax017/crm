                    ...
                    <ul class="nav nav-pills nav-justified" role="tablist">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" ng-click="switchs(&#39;mt4&#39;)" aria-selected="false">
                                ...
                                <span class="d-none d-sm-block ng-binding">MT4 account password</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="home-1" role="tabpanel">
                            <div class="table-responsive">
                                <!-- ngIf: changType=='login' --><form ng-if="changType==&#39;login&#39;" valid="" id="form" class="ng-pristine ng-scope ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength" novalidate="novalidate">

                                    <div class="mt-3">
                                        <label class="ng-binding">Current Password</label>
                                        <input class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-minlength" required="" minlength="6" data-msg-minlength=" Password length no less than 6 characters" data-msg-required="This field is required" type="password" ng-model="password.OldPassword" autocomplete="off" name="password" aria-required="true">
                                    </div>
                                    <div class="mt-3">
                                        <label class="ng-binding">New Password</label>
                                        <input class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength" data-rule-pass="true" data-msg-pass="Must contain numbers and letters" id="pass" required="" minlength="6" maxlength="20" data-msg-maxlength=" Password length is not more than 20 characters " data-msg-minlength=" Password length no less than 6 characters" data-msg-required="This field is required" type="password" ng-model="password.NewPassword" autocomplete="off" name="newpassword" aria-required="true">
                                    </div>
                                    <div class="mt-3">
