        ...
        <?php endif; ?>
            ...
            <!-- BEGIN: Personal Information -->
             <div class="flex items-center p-5 border-b border-gray-200">
                            ...
                            <p>Wallet Balance: &#8358;<?php echo e(Auth::user()->balance, false); ?></p>
                        </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="table">
                               <h2 class="text-lg font-medium truncate mr-auto">Transaction History</h2>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-b-2 whitespace-no-wrap">OLD BAL</th>
                                        <th class="border-b-2 whitespace-no-wrap">NEW BAL</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b w-32 font-medium">&#8358;<?php echo e(number_format($t->amount, 2), false); ?></td>
                                          <td class="border-b w-32 font-medium">&#8358;<?php echo e(number_format($t->old_balance, 2), false); ?></td>
                                            <td class="border-b w-32 font-medium">&#8358;<?php echo e(number_format($t->new_balance, 2), false); ?></td>
