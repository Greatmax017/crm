							...
							<div class="panel-body">
								<div class="col-md-4 col-md-offset-4">
									<table class="table table-condensed">
										...
										<!-- <tr class=""><td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#send">Credit User</button></tr> -->
									</table>
								</div>
							</div>
					</div>
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr <?php if($u->suspended): ?> class="danger" <?php elseif(!$u->activated): ?> class="warning" <?php endif; ?>>
											...
											<td class="col-md-2">
												<a href="<?php echo e(url('/admin/user/'.$u->id), false); ?>"><?php echo e($u->fname, false); ?> <?php echo e($u->surname, false); ?></a>
											</td>
											<td class="col-md-2">
