                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="alert">
                                        ...
                                        <center>
                                            <br>
                                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(url('/register').'?ref='.Auth::user()->email, false); ?>" class="btn btn-sm btn-primary"><i class="fab fa-facebook"></i> Share on Facebook</a>
                                            <a href="whatsapp://send?text=<?php echo e(url('/register').'?ref='.Auth::user()->email, false); ?>" class="btn btn-sm btn-success"><i class="fab fa-whatsapp"></i> Share on Whatsapp</a>
                                            <a href="https://t.me/share/url?url=<?php echo e(url('/register').'?ref='.Auth::user()->email, false); ?>&text=Register on Cryptobitbybit" class="btn btn-sm btn-primary"><i class="fab fa-telegram"></i> Share on Telegram</a>
                                        </center>
                                    </div>
                                </div class="col-lg-12">
                            </div>
