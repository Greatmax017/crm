							...
							<div class="panel-body">
								<div class="col-md-4 col-md-offset-4">
									<table class="table table-condensed">
										<tr><td><b>Total Networks</b></td><td><b><?php echo e($product_count, false); ?></b></td>
							...
							<div style="margin:10px; overflow-x:auto;" class="table-responsive">
								<table class="table table-striped">
									<thead>
										...
										<?php $__empty_1 = true; $__currentLoopData = $airtime; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                                         <!-- The Modal -->
										...
										<tr <?php if($u->suspended): ?> class="danger" <?php elseif(!$u->activated): ?> class="warning" <?php endif; ?>>
											...
											<td class="col-md-2">
											<?php echo e($u->network, false); ?>


                      <form class="form" role="form" method="POST" action="/admin/update_airtime">
                        <?php echo e(csrf_field(), false); ?>

                        <input type="hidden" class="" id="discount" value="<?php echo e($u->id, false); ?>" name="id">
											</td>
											...
											<td class="col-md-2">
																								...
																								<input type="text" class="" id="discount" value="<?php echo e($u->discount, false); ?>" name="discount">
