                    	...
                    	<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table">
										<tbody>
											<tr><td><b>Full Name</b></td><td> <?php echo e(isset($user->fname) ? $user->fname : 'none', false); ?> <?php echo e(isset($user->surname) ? $user->surname : 'none', false); ?><br /> <a href="/manual/login/<?php echo e($user->id, false); ?>" class="btn btn-xs btn-success">Login to account</a></td>
											
											</tr>
											<tr><td><b>One-Click Access</b></td><td> <br /> <a href="https://tradestation.neptunefx.net/manual/login/<?php echo e($user->id, false); ?>" class="btn btn-xs btn-primary">Login to Terminal</a></td></tr>
											...
											<tr><td><b>MT4:</b></td><td><b><?php echo e(isset($user->mt4) ? $user->mt4 : 'none', false); ?></b>
											<form method="POST" action="/admin/mt4">
													<?php echo e(csrf_field(), false); ?>

													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="mt4" type="number" placeholder="enter account" required>
												<button type="submit" class="btn btn-xs btn-success">Save</button>
											</form>
											</td>
										</tr>
										<tr><td><b>MT4 Password:</b></td><td><b><?php echo e(isset($user->mt4password) ? $user->mt4password : 'none', false); ?></b>
											<form method="POST" action="/admin/mt4password">
													<?php echo e(csrf_field(), false); ?>

													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="mt4password" type="text" placeholder="enter password" required>
												<button type="submit" class="btn btn-xs btn-success">Save</button>
											</form>
											</td>
										</tr>
											...
											<tr><td><b>Referred:</b></td><td><b><?php echo e(\App\User::where('referrer_id', $user->id)->count(), false); ?></b></td></tr>
                                            <!-- <tr><td><b>Total Transaction:</b></td><td>$<?php echo e(number_format(\App\Transaction::where('sender', $user->id)->where('status', 1)->sum('amount'), 2), false); ?></td></tr> -->
											<tr><td><b>Wallet Balance:</b></td><td>$<?php echo e(number_format($user->balance, 2), false); ?>
											...
											<tr><td><b>Net Asset:</b></td><td>$<?php echo e(number_format($user->net, 2), false); ?>
											...
											<tr><td><b>Margin:</b></td><td>$<?php echo e(number_format($user->margin, 2), false); ?>
											...
											<tr><td><b>Commission:</b></td><td>$<?php echo e(number_format($user->bonus, 2), false); ?>
											...
											<tr><td><b>Historical total income:</b></td><td>$<?php echo e(number_format($user->t_income, 2), false); ?>
											...
											<tr><td><b>Floating profit and loss:</b></td><td>$<?php echo e(number_format($user->pnl, 2), false); ?>
											...
											<tr><td><b>Total rate of return %:</b></td><td><?php echo e(number_format($user->return_new, 2), false); ?>
											...
											<tr><td><b>Number of Transactions:</b></td><td><?php echo e(number_format($user->transact), false); ?>
										...
										<table class="table table-striped">
											...
											<tbody>
												...
												<tr <?php if($u->suspended): ?> class="danger" <?php endif; ?>>
													...
													<td class="col-md-2">
														<strong>$<?php echo e(number_format($u->balance, 2), false); ?></strong>
													</td>
													<?php if(Auth::user()->isAdmin()): ?>
													<td class="col-md-1">
