...
<body class="not-landing landing-page landing-page1">
        ...
        <?php echo $__env->make('sections.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?><br><br>
	<div class="wrapper">
		<br />
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="panel panel-primary">
							...
							<div class="panel-body">
								<p>Please ensure that you provide the correct phone number and email address where your notifications and password reset will be sent to.</p><br />
