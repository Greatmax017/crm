            ...
            <div class="col-sm-6">
                <div class="page-title">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active ng-binding">KYC Vertification</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title ng-binding">KYC Vertification</h4>
                    ...
                    <ul class="nav nav-pills nav-justified" role="tablist">
                        ...
                        <li class="nav-item waves-effect waves-light" ng-click="tile=&#39;KYC&#39;">
                            <a class="nav-link" data-bs-toggle="tab" href="#" role="tab" aria-selected="false">
                                ...
                                <span class="d-none d-sm-block ng-binding">KYC Vertification</span>
                            </a>
                        </li>
                        ...
                        <div class="tab-pane active" id="home-1" role="tabpanel">
                                    ...
                                    <div class="row mb-3">
                                        <label class="ng-binding">Certificate Card Type：</label>
                                            ...
                                            <!-- ngIf: Language=='zh' -->
                                            <!-- ngIf: Language!='zh' -->
                                            <select disabled="" required="" data-msg-required="This field is required"  ng-if="Language!=&#39;zh&#39;" class="form-select ng-pristine ng-untouched ng-scope ng-not-empty ng-valid ng-valid-required" id="sfz" name="sfz" ng-model="resInfo.CertificateCardType">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <label for="cardfront" language="en" class="cardfront ng-isolate-scope" file-upload="commondialogOption" data-config="{&quot;card&quot;:&quot;CardNumber1&quot;,&quot;type&quot;:&quot;imgchoose&quot;,&quot;max-size&quot;:&quot;&quot;,&quot;shows&quot;:&quot;.imga&quot;,&quot;triggerCls&quot;:&quot;.show_btn&quot;,&quot;fileClass&quot;:&quot;.front&quot;}">
                                                    ...
                                                    <!-- ngIf: resInfo.CardNumber1 --><img ng-if="resInfo.CardNumber1" class="img-fluid ng-scope" ng-src="" src="imgs/logo.png"><!-- end ngIf: resInfo.CardNumber1 -->
                                                </label>
                                                <input style="opacity: 0;pointer-events: none;" class="front form-control file-opacity ng-pristine ng-untouched ng-valid ng-not-empty" type="file" ng-model="resInfo.CardNumber1" name="front" id="cardfront">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <label for="cardnagitive" language="en" class="cardnagitive ng-isolate-scope" file-upload="commondialogOption" data-config="{&quot;card&quot;:&quot;CardNumber2&quot;,&quot;type&quot;:&quot;imgchoose&quot;,&quot;max-size&quot;:&quot;&quot;,&quot;shows&quot;:&quot;.imgas&quot;,&quot;triggerCls&quot;:&quot;.cardshow_btn&quot;,&quot;fileClass&quot;:&quot;.nagitive&quot;}">
                                                    ...
                                                    <!-- ngIf: resInfo.CardNumber2 --><img ng-if="resInfo.CardNumber2" class="img-fluid ng-scope" src="imgs/logo.png"><!-- end ngIf: resInfo.CardNumber2 -->
                                                </label>
                                                <input style="opacity: 0;pointer-events: none;" class="nagitive form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="file" ng-model="resInfo.CardNumber2" name="nagitive" id="cardnagitive">
                                            </div>
                                        </div>
                                    </div>
