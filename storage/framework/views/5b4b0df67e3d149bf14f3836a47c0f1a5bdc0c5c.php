...
<div class="what-w3ls py-5" id="services">
    <div class="container py-xl-5 py-lg-3">
        <div class="text-center mb-md-5 mb-4">
            ...
            <p>Cryptobitbybit Trade in the following fields</p>
        </div>
                    ...
                    <div class="price-inner">
                        ...
                        <div class="price-body">
                            <h5 class="pricing-title">
                                <span class="dolor">$</span> 20.00
                                <label>Per Investment</label>

                            </h5>

                            <ul class="list-unstyled mt-3 mb-4">
                                <li class="py-2 border-bottom">20% Returns</li>
