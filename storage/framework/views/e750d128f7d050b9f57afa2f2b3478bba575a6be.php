  ...
  <div class="modal fade" id="send" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Credit a user</h4>
        </div>
        <div class="modal-body">
		 ...
		 <input id="phone" placeholder="enter user Phone Number" type="tel" name="phone" required><br>
		 <label> Amount to send </label>
		 <input id="amount" placeholder="enter amount" type="number" name="amount" required><br>
		 <center><button type="submit">Credit</button></center>
							...
							<div class="panel-body">
								<div class="col-md-4 col-md-offset-4">
									<table class="table table-condensed">
										...
										<tr class=""><td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Create Admin</button></td><tr class=""><td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#send">Credit User</button></tr>
									</table>
								</div>
							</div>
					</div>
