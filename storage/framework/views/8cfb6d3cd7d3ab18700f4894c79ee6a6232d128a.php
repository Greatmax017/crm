								...
								<div class="table-responsive">
									<table class="table table-condensed">
										<tbody>
											...
											<tr><td><b>Sender Email:</b></td><td><b><a href="<?php echo e(url('/admin/user/'.$message->sender)); ?>"><?php echo e(isset($message->sender_data->email) ? $message->sender_data->email : 'support@10in10trading.com'); ?></a> <?php if($message->sender != 0): ?> <a href="/admin/message/reply/<?php echo e($message->id); ?>" class="btn btn-xs btn-primary">Reply</a> <?php endif; ?></b></td></tr>
											<tr><td><b>Receiver Name</b></td><td> <?php echo e(isset($message->receiver_data->name) ? $message->receiver_data->name : 'Support'); ?><br /></td></tr>
											<tr><td><b>Receiver Email:</b></td><td><b><a href="<?php echo e(url('/admin/user/'.$message->receiver)); ?>"><?php echo e(isset($message->receiver_data->email) ? $message->receiver_data->email : 'support@10in10trading.com'); ?></a></b></td></tr>
