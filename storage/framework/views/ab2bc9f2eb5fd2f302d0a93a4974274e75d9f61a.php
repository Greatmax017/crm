								...
								<div class="table-responsive">
									<table class="table">
										<tbody>
											...
											<tr><td><b>One-Click Access</b></td><td> <br /> <a href="https://trade.neptunefx.net/manual/login/<?php echo e($user->id, false); ?>" class="btn btn-xs btn-primary">Login to Terminal</a></td></tr>
											...
											<tr><td><b>Account:</b></td><td><b><?php echo e(isset($user->mt4) ? $user->mt4 : 'none', false); ?></b>
										...
										<tr><td><b>Account mode:</b></td><td><b><?php echo e(isset($user->live) ? $user->live : 'none', false); ?></b>
											<form method="POST" action="/admin/mt4password">
													<?php echo e(csrf_field(), false); ?>

													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="live" type="text" value="<?php echo e($user->live, false); ?>" required>
												<button type="submit" class="btn btn-xs btn-success">Save</button>
											</form>
											</td>
										</tr>
