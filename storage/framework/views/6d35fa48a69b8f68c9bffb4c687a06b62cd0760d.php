											...
											<div class="row">
												<div class="form-group<?php echo e($errors->has('captcha') ? ' has-error' : ''); ?>">
													<div class="col-xs-8 col-sm-4 col-xs-offset-2 col-sm-offset-4">
														<div style="width:166px; padding-bottom:20px;padding-top:20px;">
															<center>
																<div class="pull-left" id="captcha_img">
																	<?php echo captcha_img();; ?>

																</div>
																<a class="btn btn-xs pull-right" onclick="document.getElementById('captcha_img').getElementsByTagName('img')[0].setAttribute('src', '/captcha/default?'+ Math.random());">
																	<i class="fa fa-refresh"></i>
																</a>
															</center>
														</div>
														<input style="max-width:166px;" type="text" class="form-control" placeholder="captcha" autocomplete="off" name="captcha" required>
