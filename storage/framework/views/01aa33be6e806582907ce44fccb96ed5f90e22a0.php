								...
								<div class="panel-body">
									<div class="col-md-12">
										<table class="table table-condensed">
											<tr class="success"><td><b>Total Paid Amount</b></td><td><b><?php echo e(number_format($paid_withdrawals, 6), false); ?></b></td></tr>
										</table>
									</div>
								</div>
							</div>
									...
									<table class="table">
										...
										<tbody>
											...
											<tr>
												...
												<td  class="col-md-1"><b><?php echo e(number_format($t->amount, 6), false); ?> btc</b></td>
	                                            <td class="col-md-3">
	                                            ...
	                                            <td>
	                                                <?php if($t->status == 2): ?>
	                                                <a onclick="submitForm(this);" form-id="confirm-payment-form-<?php echo e($t->id, false); ?>" form-action="confirm payment of <?php echo e(number_format($t->amount, 6), false); ?> btc" style="margin-top:5px; margin-bottom:5px;" class="btn btn-sm btn-info">
													    Confirm Payment
													</a>
