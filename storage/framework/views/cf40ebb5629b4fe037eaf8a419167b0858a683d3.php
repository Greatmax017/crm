							...
							<div class="panel-body">
							    ...
							    <form class="form" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('sort_code') ? ' has-error' : ''); ?>">
										...
										<input type="text" class="form-control" placeholder="Sort Code" value="<?php echo e(old('sort_code')); ?>" name="sort_code">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('bitcoin_wallet_id') ? ' has-error' : ''); ?>">
										...
										<input type="text" class="form-control" placeholder="Bitcoin Wallet ID" value="<?php echo e(old('bitcoin_wallet_id')); ?>" name="bitcoin_wallet_id">
