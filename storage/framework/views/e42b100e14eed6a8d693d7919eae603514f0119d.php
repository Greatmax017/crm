              		...
              		<div class="col-md-10 col-md-offset-1">
						 <div class="panel panel-danger">
							...
							<div class="panel-body">
								...
								<div class="form-group <?php echo e($errors->has('min_amount') ? ' has-error' : '', false); ?>">
									<label class="control-label">Gold Account Minimum Investment Amount:</label>
									<input type="text" class="form-control" name="min_amount" value="<?php echo e($settings->min_amount, false); ?>" required autofocus>
									<?php if($errors->has('min_amount')): ?>
									    <span class="label label-danger">
										<strong><?php echo e($errors->first('min_amount'), false); ?></strong>
									    </span>
									<?php endif; ?>
								</div>
								<div class="form-group <?php echo e($errors->has('premium_min_amount') ? ' has-error' : '', false); ?>">
									<label class="control-label">Premium Account Minimum Investment Amount:</label>
									<input type="text" class="form-control" name="premium_min_amount" value="<?php echo e($settings->premium_min_amount, false); ?>" required autofocus>
									<?php if($errors->has('premium_min_amount')): ?>
									    <span class="label label-danger">
										<strong><?php echo e($errors->first('premium_min_amount'), false); ?></strong>
									    </span>
									<?php endif; ?>
								</div>
