									...
									<div class="row">
										<div class="col-lg-12">
											<div class="alert alert-success">
												<p class="text-center">Your Referral Link is <a href="https://www.todaylift.com/register?ref=<?php echo e(Auth::user()->id); ?>"><b>https://www.todaylift.com/register?ref=<?php echo e(Auth::user()->id); ?></b></a></p>
											</div>
										</div>
										<div style="padding:15px;" class="card-info">
											<p><i><b>Note:</b> You will earn N500 for each person you refer</i></p>
										</div>
									</div>
