								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="/admin/message/<?php echo e($m->id); ?>" <?php if($m->message_read == 0): ?> style="font-weight:900;" <?php endif; ?>><?php echo e(isset($m->sender_data->email) ? $m->sender_data->email : 'Support'); ?></a></td>
											<td><a href="/admin/message/<?php echo e($m->id); ?>" <?php if($m->message_read == 0): ?> style="font-weight:900;" <?php endif; ?>><?php echo e(isset($m->subject) ? $m->subject : ''); ?></a></td>
