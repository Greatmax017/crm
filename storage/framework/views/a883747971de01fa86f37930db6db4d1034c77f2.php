              ...
              <div class="row">
              		<div class="panel panel-danger">
						...
						<div class="panel-body">
							<form id="send-message" class="form" role="form" method="POST" action="<?php echo e(url('/admin/send_message'), false); ?>" enctype="multipart/form-data">
								<?php echo e(csrf_field(), false); ?>


								<div class="form-group<?php echo e($errors->has('email') ? ' has-error' : '', false); ?>">
								   <label for="email" class="control-label">Send to:</label>
								   <input class="form-control" name="email" value="<?php echo e(isset($email) ? $email : '', false); ?>">
								</div>

								<div class="form-group<?php echo e($errors->has('subject') ? ' has-error' : '', false); ?>">
								   <label for="subject" class="control-label">Subject:</label>
								   <input id="subject" type="text" class="form-control" placeholder="Message Subject" name="subject" value="<?php echo e(isset($subject) ? $subject : '', false); ?>" required autofocus>
