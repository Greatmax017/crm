  ...
  <div class="modal fade" id="send" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">USDT Wallet Address</h4>
        </div>
        <div class="modal-body">
		 ...
		 <input id="amount" placeholder="enter ERC20 address" type="text" name="ERC20" ><br>
								...
								<div class="col-md-4 col-md-offset-4">
									<table class="table table-condensed">
										...
										<tr class=""><td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Create Admin</button></td>
										 <tr class=""><td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#send">USDT Wallets</button></tr> 
									</table>
								</div>
							</div>
					</div>
