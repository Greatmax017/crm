					...
					<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-condensed">
										<tbody>
											...
											<tr><td><b>Sender Email:</b></td><td><b><?php echo e(isset($message->sender_data->email) ? $message->sender_data->email : 'support@todaylift.com'); ?> <?php if($message->sender != 0): ?> <a href="/admin/message/reply/<?php echo e($message->id); ?>" class="btn btn-xs btn-primary">Reply</a> <?php endif; ?></b></td></tr>
											<tr><td><b>Receiver Name</b></td><td> <?php echo e(isset($message->receiver_data->name) ? $message->receiver_data->name : 'Support'); ?><br /></td></tr>
											<tr><td><b>Receiver Email:</b></td><td><b><?php echo e(isset($message->receiver_data->email) ? $message->receiver_data->email : 'support@todaylift.com'); ?></b></td></tr>
								...
								<div class="form-group">
									...
									<a href="/admin/messagebox" class="btn btn-sm btn-primary">
									    Return to Messages
									</a><br /><br />
								    </div>
								</div>
