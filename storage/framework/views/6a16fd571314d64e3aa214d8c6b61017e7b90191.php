...
<html lang="en">
<head>
    <title>Cryptobitbybit | Home</title>
    <!-- Meta tag Keywords -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 header-loginw3ls text-lg-right text-center">
                                        <a href="<?php echo e(url('/dashboard'), false); ?>" class="log">
                                            <i class="fas fa-user mr-2"></i> Welcome, <?php echo e(Auth::user()->name, false); ?>
...
<div class="copy_right py-4 text-center">
    <p class="text-white">© 2018 Cryptobitbybit. All rights reserved | Design by
