                    ...
                    <div class="clearfloat">
                        <!-- ngIf: deposit.moneyType!='otcpaysdigital_BTC'
                            ...
                            <div class="mb-3 col-lg-3">
                                ...
                                <label class="mt-3 font-size-14 text-white ng-binding">Wallet Address: <?php if($trx->network == 'ERC20'): ?> <?php echo e($a->ERC20, false); ?> <?php else: ?> <?php echo e($a->TRC20, false); ?> <?php endif; ?> </label><br>
