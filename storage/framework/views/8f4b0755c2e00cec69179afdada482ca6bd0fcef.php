<?php $__env->startSection('head'); ?>
    <title>reset password - Neptunfx</title>
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">A few more clicks to <br>regain access to your account.</div>
						...
						<?php if(session('error-status')): ?>
							...
							<?php if(session('success-status')): ?>
									...
									<b>Error:</b> <?php echo e(session('success-status'), false); ?>
							...
							<div class="alert alert-danger">
								<div class="container-fluid">
									...
									<b>Error:</b> <?php echo e(session('status'), false); ?>
                    ...
                    <div class="intro-x mt-8">
									<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/password/email'), false); ?>">
										...
										<div class="form-group<?php echo e($errors->has('email') ? ' has-error' : '', false); ?>">
											...
											<div class="col-md-12">
												<input id="email" placeholder="Enter Email" type="email" class="intro-x login__input input input--lg border border-gray-300 block" name="email" value="<?php echo e(old('email'), false); ?>" required>
