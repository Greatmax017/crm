						...
						<div class="panel-body">
							<form id="send-message" class="form" role="form" method="POST" action="<?php echo e(url('/send_message')); ?>" enctype="multipart/form-data">
								...
								<div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
								   <label for="email" class="control-label">Send to (Type 'support' to send a complaint to support):</label>
								   <input id="email" type="email" class="form-control" placeholder="Registered email" name="email" value="<?php echo e(isset($email) ? $email : 'support'); ?>" required autofocus>
