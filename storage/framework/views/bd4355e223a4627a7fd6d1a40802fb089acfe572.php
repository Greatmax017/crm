            ...
            <div class="col-lg-3 col-md-4">
                <div class="card" style="width: 100%;">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><a href="<?php echo e(url('/transaction_history'), false); ?>" class="btn btn-xs btn-block btn-warning text-left"><i class="fa fa-chart-line"></i> My Transactions</a></li>
                        <li class="list-group-item"><a href="<?php echo e(url('/referred_bonus'), false); ?>" class="btn btn-xs btn-block btn-warning text-left"><i class="fa fa-users"></i> Referred Users</a></li>
                        <li class="list-group-item"><a href="<?php echo e(url('/profile'), false); ?>" class="btn btn-xs btn-block btn-warning text-left"><i class="fa fa-user"></i> My Profile</a></li>
                        <li class="list-group-item"><a href="<?php echo e(url('/messagebox'), false); ?>" class="btn btn-xs btn-block btn-warning text-left"><i class="fa fa-life-ring"></i> Support</a></li>
                        <li class="list-group-item"><a href="<?php echo e(url('/logout'), false); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-xs btn-block btn-warning text-left"><i class="fa fa-lock"></i> Logout</a></li>
                    </ul>
                </div>
                <div id="newInvestment" class="modal" tabindex="-1" role="dialog" style="z-index:9999;">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p><center>
                                        <br>
                                        Minimum Amount: $<?php echo e($min_amount, false); ?>
                                ...
                                <form id="investment-form" action="<?php echo e(url('/investment-request'), false); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <input
                                            ...
                                            onkeyup="document.getElementById('result').innerHTML = (document.getElementById('usd-bitcoin-rate').value * this.value).toFixed(6);" required />
                                    </div>
                                    <!--div class="form-group">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="alert alert-info">
                            <center>
                                <h4 style="margin-bottom: 10px;"><i class="fa fa-money"></i> Active Investments</h4>
