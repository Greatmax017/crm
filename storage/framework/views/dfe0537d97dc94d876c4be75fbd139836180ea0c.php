                    	...
                    	<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table">
										<tbody>
											<tr><td><b>Full Name</b></td><td> <?php echo e(isset($user->fname) ? $user->fname : 'none', false); ?> <?php echo e(isset($user->surname) ? $user->surname : 'none', false); ?><br /> <a href="/manual/login/<?php echo e($user->id, false); ?>" class="btn btn-xs btn-success">Login to account</a></td></tr>
										...
										<tr><td><b>MT4 Password:</b></td><td><b><?php echo e(isset($user->mt4password) ? $user->mt4password : 'none', false); ?></b>
											...
											<tr><td><b>Wallet Balance:</b></td><td>$<?php echo e(number_format($user->balance, 2), false); ?>
												...
												<form method="POST" action="/admin/balance">
													...
													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="balance" type="number" placeholder="enter new balance" required>
												<button type="submit" class="btn btn-xs btn-success">save</button>
											</form>
											</td></tr>
											<tr><td><b>Net Asset:</b></td><td>$<?php echo e(number_format($user->net, 2), false); ?>
												...
												<form method="POST" action="/admin/net">
													...
													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="net" type="text" placeholder="enter new net" required>
												<button type="submit" class="btn btn-xs btn-success">save</button>
											</form>
											</td></tr>
											<tr><td><b>Margin:</b></td><td>$<?php echo e(number_format($user->margin, 2), false); ?>
												...
												<form method="POST" action="/admin/margin">
													...
													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="margin" type="number" placeholder="enter new margin" required>
												<button type="submit" class="btn btn-xs btn-success">save</button>
											</form>
											</td></tr>
											<tr><td><b>Commission:</b></td><td>$<?php echo e(number_format($user->bonus, 2), false); ?>
												...
												<form method="POST" action="/admin/bonus">
													...
													<input type="hidden" name="email" value="<?php echo e($user->email, false); ?>">
													<input name="bonus" type="text" placeholder="enter new commission" required>
												<button type="submit" class="btn btn-xs btn-success">save</button>
											</form>
											</td></tr>
										</tbody>
