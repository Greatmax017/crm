									...
									<tbody>
										...
										<tr <?php if($t->status == 1): ?> class="success" <?php elseif($t->status == 2): ?> class="danger" <?php else: ?> class="warning" <?php endif; ?> >
                                            ...
                                            <td class="col-md-3">
	                                            ...
	                                            <b>Bank:</b> <?php echo e(isset($t->receiver_data->bank_name) ? $t->receiver_data->bank_name : ''); ?> <br />
                                            ...
                                            <td>
                                                <?php if($t->status == 0): ?>
                                                <a onclick="submitForm(this);" form-id="confirm-payment-form-<?php echo e($t->id); ?>" form-action="confirm payment of &#8358;<?php echo e(number_format($t->amount)); ?>" style="margin-top:5px; margin-bottom:5px;" class="btn btn-sm btn-info">
												    Confirm Payment
												</a>
