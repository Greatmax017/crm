          		...
          		<?php if(Auth::user()->activated == 0): ?>
					<div class="alert alert-danger alert-dismissable">
					    ...
					    <div class="container-fluid">
					      <center>Email account is not yet activated. Only activated users can Get Donation <a href="/resend_activation" class="btn btn-xs">Resend Activation Email</a></center>
					    </div>
					</div>
				<?php endif; ?>
				                                ...
				                                <div class="panel panel-success">
				                                    ...
				                                    <div id="collapse<?php echo e($c->id); ?>" class="panel-collapse collapse <?php if(Auth::user()->category_id == $c->id): ?> in <?php endif; ?>">
				                                        <div class="panel-body">
				                                            ...
				                                            <span style="color:red; font-weight:20px;">Please ensure you have the money at hand before clicking on the donate button because if you do not make donation within <?php echo e($settings->payment_time); ?> hour(s), your account will be deleted</span></p>
					                                        <center>
									...
									<div class="panel-body">
										<table class="table table-condensed">
											...
											<tbody>
												...
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
													<tr>
														<td colspan="3"><center><i><b>You have no locked balance. Donate now to get donations</b></i></center></td>
													</tr>
												<?php endif; ?>
											</tbody>
										</table>
							...
							<div class="col-lg-6">
								<div style="max-width:380px;" class="receipt-card table-responsive">
									...
									<?php if($t->sender_confirm == 1): ?>
										...
										<a onclick="submitForm(this);" form-id="complain-form-<?php echo e($t->id); ?>" form-action="Dispute this transaction">dispute the transaction</a></p><br />
      	...
      	<div id="newTestimony" class="modal fade" role="dialog">
			  <div class="modal-dialog">
				...
				<form id="new_cat" action="<?php echo e(url('/share_testimony')); ?>" method="POST">
					...
					<div class="form-group">
						<label class="control-label">Testimony (Please let others know what you think of MFC):</label>
