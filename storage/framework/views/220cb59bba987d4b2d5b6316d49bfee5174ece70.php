      ...
      <!--main content start-->
			...
			<?php if(session('error-status')): ?>
				...
				<div class="alert alert-danger">
				 ...
				 <div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-6 text-white"> <i data-feather="alert-octagon" class="w-6 h-6 mr-2"></i>
					<b>Error: &nbsp </b>  Your account has been suspended Please contact support
				</div>
		</div>
		<?php endif; ?>
		  ...
		  <div class="modal" id="warning-modal-preview">
				 <div class="modal__content"> <div class="p-5 text-center">

					  <div class="text-3xl mt-5">	posts->content </div>
