        ...
        <div class="row">
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                 <div class="header-page-locator">
                     <ul>
                         <li><a href="<?php echo e(url('/dashboard'), false); ?>">Back-Office /</a> Profile</li>
                     </ul>
                 </div>
             </div>
        </div>
                            ...
                            <div class="panel-body">
                                <form id="profile-form" class="form" role="form" method="POST" action="<?php echo e(url('/profile'), false); ?>">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('name') ? ' has-error' : '', false); ?>">
                                        ...
                                        <input type="text" class="form-control" placeholder="Full Name" name="name" value="<?php echo e(Auth::user()->name, false); ?>" required autofocus disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="country" value="<?php echo e(Auth::user()->country, false); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Bank Name" value="<?php echo e(Auth::user()->bank_name, false); ?>" name="bank_name">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('account_number') ? ' has-error' : '', false); ?>">
                                        ...
                                        <input type="text" class="form-control" placeholder="Account Number" value="<?php echo e(Auth::user()->account_number, false); ?>" name="account_number">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('sort_code') ? ' has-error' : '', false); ?>">
                                        ...
                                        <input type="text" class="form-control" placeholder="Sort Code" value="<?php echo e(Auth::user()->sort_code, false); ?>" name="sort_code" disabled>
                                    ...
                                    <div class="form-group<?php echo e($errors->has('bitcoin_wallet_id') ? ' has-error' : '', false); ?>">
                                        ...
                                        <input type="text" class="form-control" placeholder="Bitcoin Wallet ID" value="<?php echo e(Auth::user()->bitcoin_wallet_id, false); ?>" name="bitcoin_wallet_id">
