                            ...
                            <div class="col-xl-6">
                                <div class="dash-info-widget mt-4 mt-lg-0 py-4 px-3 rounded">
                                    ...
                                    <div class="media mt-4">
                                        ...
                                        <div class="media-body ps-3">
                                            <h4 class="font-size-20 ng-binding">$<?php echo e(number_format(Auth::user()->balance, 2), false); ?></h4>
                                ...
                                <div class="dash-info-widget mt-4 mt-lg-0 py-4 px-3 rounded">
                                    ...
                                    <div class="media dash-main-border pb-2 mt-2">
                                        ...
                                        <div class="media-body ps-3">
                                            ...
                                            <h4 class="font-size-20 ng-binding"><?php echo e(Auth::user()->transact, false); ?></h4>
                                            <p class="text-muted ng-binding">
                                    ...
                                    <div class="media mt-4">
                                        ...
                                        <div class="media-body ps-3">
                                            <h4 class="font-size-20 ng-binding color-f23244" ng-class="{true:&#39;color-f23244&#39;,false:&#39;color-61cb28&#39;}[AccountInfo.profitrate&gt;=0]" style="color:#66ff66;"><?php echo e(number_format($percentage, 2), false); ?>%</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $ongoing_trades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr ng-if="NowPos.length==0&amp;&amp;!loading_min" class="ng-scope">
                                            <td><?php echo e($t->id, false); ?></td>
                                            <td><?php echo e(Auth::user()->mt4, false); ?></td>
                                            <td><?php echo e($t->created_at, false); ?></td>
                                            <td><?php echo e($t->symbol, false); ?></td>
                                            <td><?php echo e($t->entry_price, false); ?></td>
                                             <td><?php echo e($t->volume, false); ?></td>
                                            <td><?php echo e($t->side, false); ?></td>
                                ...
                                <table class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                         ...
                                         <!--ngIf: NowPos.length==0&&!loading_min -->
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $trades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr ng-if="NowPos.length==0&amp;&amp;!loading_min" class="ng-scope">
                                            <td><?php echo e($t->id, false); ?></td>
                                            <td><?php echo e($t->created_at, false); ?></td>
                                            <td><?php echo e($t->side, false); ?></td>
                                            ...
                                            <td><?php echo e($t->volume, false); ?></td>
                                            <td><?php echo e($t->entry_price, false); ?></td>
                                            <td><?php echo e($t->exit_price, false); ?></td>
                                            <td><?php echo e($t->profit, false); ?></td>
