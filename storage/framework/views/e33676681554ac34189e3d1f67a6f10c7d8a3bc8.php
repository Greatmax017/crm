										...
										<div class="table-responsive">
											<table class="table table-condensed">
												<tbody>
        											...
        											<tr><td><b>Sender Email:</b></td><td><b><?php echo e(isset($message->sender_data->email) ? $message->sender_data->email : 'support@todaylift.com'); ?> <a href="/message/reply/<?php echo e($message->id); ?>" class="btn btn-xs btn-primary">Reply</a></b></td></tr>
