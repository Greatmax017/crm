                            ...
                            <div class="col-xl-6">
                                <div class="dash-info-widget mt-4 mt-lg-0 py-4 px-3 rounded">
                                    ...
                                    <div class="media mt-4 dash-main-border pb-2">
                                        ...
                                        <div class="media-body ps-3">
                                            <h4 class="font-size-20 ng-binding">$<?php echo e(Auth::user()->t_income, false); ?></h4>
                                    ...
                                    <div class="media mt-4 dash-main-border pb-2">
                                        ...
                                        <div class="media-body ps-3">
                                            <h4 class="font-size-20 ng-binding color-f23244" ng-class="{true:&#39;color-f23244&#39;,false:&#39;color-61cb28&#39;}[AccountInfo.floatprofit&gt;=0]" ><?php echo e(Auth::user()->pnl, false); ?></h4>
                                    ...
                                    <div class="media mt-4">
                                        ...
                                        <div class="media-body ps-3">
                                            <h4 class="font-size-20 ng-binding color-f23244" ng-class="{true:&#39;color-f23244&#39;,false:&#39;color-61cb28&#39;}[AccountInfo.profitrate&gt;=0]" style="color:#66ff66;"><?php echo e(Auth::user()->return_new, false); ?>%</h4>
