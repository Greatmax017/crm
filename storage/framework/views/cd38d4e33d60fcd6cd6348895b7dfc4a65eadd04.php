        ...
        <div class="mobile-menu md:hidden">
            ...
            <ul class="border-t border-theme-24 py-5 hidden">
                ...
                <li>
                    ...
                    <li>
                        <a href="/electricity" class="menu <?php echo e(Request::is('electricity') ? 'menu--active' : '', false); ?>">
                            <div class="menu__icon"> <i data-feather="circle"></i> </div>
                            <div class="menu__title"> Electricity</div>
                        </a>
                    </li>
                     <li>
                        <a href="education" class="menu <?php echo e(Request::is('education') ? 'menu--active' : '', false); ?>">
                ...
                <!--admin-->
                 <li>
                    <a href="/admin/users" class="menu <?php echo e(Request::is('admin') ? 'menu--active' : '', false); ?>">
 ...
 <!-- BEGIN: Side Menu -->
            <nav class="side-nav">
                ...
                <ul>
                    ...
                    <li>
                        <a href="#" class="side-menu <?php echo e(Request::is('admin') ? 'side-menu--active' : '', false); ?> button inline-block bg-theme-1 text-white ">
