              		...
              		<div class="col-md-10 col-md-offset-1">
						 <div class="panel panel-danger">
							...
							<div class="panel-body">
								...
								<div class="form-group <?php echo e($errors->has('normal_rate') ? ' has-error' : '', false); ?>">
									<label class="control-label">Normal Account Rate:</label>
									<input type="text" class="form-control" name="normal_rate" value="<?php echo e($settings->normal_rate, false); ?>" required>
									<?php if($errors->has('normal_rate')): ?>
									    <span class="label label-danger">
										<strong><?php echo e($errors->first('normal_rate'), false); ?></strong>
									    </span>
									<?php endif; ?>
								</div>

								<div class="form-group <?php echo e($errors->has('executive_rate') ? ' has-error' : '', false); ?>">
									<label class="control-label">Executive Account Rate:</label>
									<input type="text" class="form-control" name="executive_rate" value="<?php echo e($settings->executive_rate, false); ?>" required>
									<?php if($errors->has('executive_rate')): ?>
									    <span class="label label-danger">
										<strong><?php echo e($errors->first('executive_rate'), false); ?></strong>
									    </span>
									<?php endif; ?>
								</div>
