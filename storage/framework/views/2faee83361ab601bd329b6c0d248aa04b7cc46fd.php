									...
									<div class="row">
										<div class="col-lg-12">
											<div class="alert alert-success">
												<p class="text-center">Your Referral Link is <a href="https://www.10in10trading.com/register?ref=<?php echo e(Auth::user()->id); ?>"><b>https://www.10in10trading.com/register?ref=<?php echo e(Auth::user()->id); ?></b></a></p>
											</div>
										</div><p><a href="https://form.myjotform.com/80456227648564">Apply to become an affiliate in your country</a></p><p><script type="text/javascript" src="https://form.myjotform.com/jsform/80456227648564"></script></p>
									</div>
