              ...
              <ul class="sidebar-menu" id="nav-accordion">
				...
				<ul class="nav nav-second-level">
				  ...
				  <li><a class="<?php echo e(Request::is('admin/withdrawals') ? 'active' : '', false); ?>" href="<?php echo e(url('/admin/withdrawals'), false); ?>">Withdrawals</a></li>
				   <li><a class="<?php echo e(Request::is('admin/kyc') ? 'active' : '', false); ?>" href="<?php echo e(url('/admin/kyc'), false); ?>">KYC</a></li>

                    <li><a class="<?php echo e(Request::is('admin/account/usd') ? 'active' : '', false); ?>" href="<?php echo e(url('/admin/account/usd'), false); ?>">USD account</a></li>
                    <li><a class="<?php echo e(Request::is('admin/account/gbp') ? 'active' : '', false); ?>" href="<?php echo e(url('/admin/account/gbp'), false); ?>">GBP account</a></li>
                    <li><a class="<?php echo e(Request::is('admin/account/eur') ? 'active' : '', false); ?>" href="<?php echo e(url('/admin/account/eur'), false); ?>">EUR account</a></li>
