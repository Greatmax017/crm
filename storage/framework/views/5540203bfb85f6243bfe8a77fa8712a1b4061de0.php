...
<html lang="en">
<head>
    <title>Digimexcrypto | <?php if(Request::segment(1) == ''): ?> Home <?php else: ?> <?php echo e(ucfirst(Request::segment(1)), false); ?> <?php endif; ?></title>
    <!-- Meta tag Keywords -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="UTF-8" />
    <meta name="keywords" content="Bitcoin, trading, gain" />
    <meta name="csrf-token" content="<?php echo e(csrf_token(), false); ?>">
    <meta name="description" content="Digimexcrypto Bitcoin Trading Company is a professional investment corporation engaged in stock market, foreign exchange market, Forex Trade and gold trading." />
                    ...
                    <div class="row border-bottom py-lg-4 py-3">
                        <div class="col-md-8 col-lg-6 header_agileits_left">
                            <ul>
                                        ...
                                        <a href="mailto:support@digimexcrypto.com">support@digimexcrypto.com</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <a class="navbar-brand" href="<?php echo e(url('/'), false); ?>">digimexcrypto
    ...
    <div class="banner-text-agile">
        <div class="container">
            <div class="banner-w3lstexts text-white text-center">
                <h1>Welcome to digimexcrypto</h1>
    ...
    <div class="container py-xl-5 py-lg-3">
        ...
        <div class="w3social-icons-footer text-center pt-sm-5 pt-3">
            <ul>
                ...
                <li>
                    <a href="https://t.me/joinchat/Iwg8cRTnbwPvXTgVAGC8xg" class="rounded-circle">
...
<div class="copy_right py-4 text-center">
    <p class="text-white">© 2019 digimexcrypto. All rights reserved
    </p>
</div>
<!-- //copyright -->
