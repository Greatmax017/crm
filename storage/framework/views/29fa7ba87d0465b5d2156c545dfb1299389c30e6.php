									...
									<thead>
										...
										<?php echo e($u->network, false); ?>
                                            ...
                                            <input type="text" class="" id="code" value="<?php echo e($u->code, false); ?>" placeholder="Enter code" name="code">
																						<input type="hidden" class="" id="code" value="<?php echo e($u->code, false); ?>" placeholder="Enter code" name="old_code">
											...
											<td class="col-md-2">
																								...
																								<input type="number" class="" id="discount" value="<?php echo e($u->discount, false); ?>" name="discount">
