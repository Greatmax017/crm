          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="section-header left-style">
                ...
                <p>
                  Alstomfx - a pacesetting trading training institute.Our goal
                  is to educate you with the relevant knowledge on the majors
                  you need to know about Binary Options Trading, Forex Trading
                  and cryptocurrency Trading which include blockchain
                  technology.
                </p>
              </div>
            ...
            <div class="col-lg-7 col-xl-6">
              <div class="ceo-content">
                ...
                <div class="author">
                  ...
                  <span class="info">CEO of Alstomfx</span>
                  <div class="sign">
              ...
              <div class="mission-wrapper owl-theme owl-carousel">
                <div class="mission-item">
                  ...
                  <div class="mission-content">
                    ...
                    <p>minimum investment amount from &#8358;200,000</p>
                    <a href="/register"
                ...
                <div class="mission-item">
                  ...
                  <div class="mission-content">
                    ...
                    <p>Automated Investment system</p>
                    <a href="/register"
                      >Learn More <i class="flaticon-right-arrow"></i
                    ></a>
                  </div>
                ...
                <div class="mission-item">
                  ...
                  <div class="mission-content">
                    <h5 class="title">Real-time data</h5>
                    <p>All transactions are updated in realtime</p>
                    <a href="/register"
                      >Learn More <i class="flaticon-right-arrow"></i
                    ></a>
                  </div>
                ...
                <div class="mission-item">
                  ...
                  <div class="mission-content">
                    ...
                    <p>Secured and transaparent transactions</p>
                    <a href="/register"
                      >Learn More <i class="flaticon-right-arrow"></i
                    ></a>
                  </div>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-xl-6">
              <div class="section-header">
                ...
                <h2 class="title">Our Top Investors</h2>
                <p>
